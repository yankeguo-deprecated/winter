...
// Encode appends PKCS#7 padding to the given buffer such that the resulting slice
...
// Decode returns a subslice of the input buffer with trailing PKCS#7 padding
